...
public class AddProducts_CartPage {
	...
	AddProducts_CartPage(WebDriver driver){
		this.driver=driver;
	...
	@FindBy(xpath="(//a[@data-product-id='1'])[1]")WebElement btn_AddToCart_1;
	@FindBy(xpath="//img[@src='/get_product_picture/1']")WebElement product_1;
	@FindBy(xpath="//button[@class='btn btn-success close-modal btn-block']")WebElement btn_ContinueShopping;
	@FindBy(xpath="(//a[@data-product-id='2'])[2]")WebElement btn_AddToCart_2;
	@FindBy(xpath="//img[@src='/get_product_picture/2']")WebElement product_2;
	@FindBy(xpath="//u[text()='View Cart']//parent::a")WebElement btn_ViewCart;
	@FindBy(xpath="//table[@id='cart_info_table']//tbody//tr") List<WebElement> table;
